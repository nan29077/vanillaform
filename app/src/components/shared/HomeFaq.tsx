...
const FAQS = [
  { q: "바닐라폼는 어떤 서비스인가요?", a: "브랜드의 좋은 상품을 신뢰하는 라이브 셀러(인플루언서)를 통해 만나는 단골 중심 커머스예요. 좋아하는 라이브 셀러를 PICK하고, 그 라이브 셀러만의 샵과 라이브를 즐길 수 있어요." },
  { q: "다른 라이브 셀러는 어떻게 찾나요?", a: "메인 상단의 검색창에서 라이브 셀러 이름이나 라이브 코드로 검색하면 돼요. 바닐라폼는 아무나 둘러보는 곳이 아니라, 내가 아는·좋아하는 라이브 셀러와 깊게 연결되는 단골형 서비스예요." },
  ...
  { q: "결제·배송·환불은 안전한가요?", a: "바닐라폼는 통신판매중개자로서 안전한 거래 시스템을 제공해요. 주문·배송 현황은 마이페이지에서 확인할 수 있고, 알림으로도 안내해 드려요." },
];
