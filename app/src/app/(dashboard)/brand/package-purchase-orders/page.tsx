...
export default async function BrandPackagePurchaseOrdersPage() {
    ...
    <div className="animate-fade-in">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-500 mt-1">
          본인 브랜드 상품이 포함된 패키지 주문의 발주서입니다.
        </p>
      </div>
      <PackagePurchaseOrdersClient purchaseOrders={serialized} role="BRAND_ADMIN" />
    </div>
  );
}
